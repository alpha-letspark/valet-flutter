...
class CardBasedEntryRequest {
  ...
  CardBasedEntryRequest copyWith({
    String? client_id,
    String? entry_user_id,
    String? vehicle_number,
    String? vehicle_type,
  ...
  factory CardBasedEntryRequest.fromMap(Map<String, dynamic> map) {
    return CardBasedEntryRequest(
  ...
  factory CardBasedEntryRequest.fromJson(String source) =>
      CardBasedEntryRequest.fromMap(json.decode(source));

  @override
  String toString() {
    return 'CardBasedEntryRequest(client_id: $client_id, entry_user_id: $entry_user_id, vehicle_number: $vehicle_number, vehicle_type: $vehicle_type, valuable: $valuable, valuable_things: $valuable_things, image_names: $image_names, driver: $driver, location: $location, hook_number: $hook_number, notes: $notes, is_parked: $is_parked, vehicle_name: $vehicle_name, vehicle_color: $vehicle_color, slots: $slots)';
  }
  ...
  bool operator ==(Object other) {
    ...
    return other is CardBasedEntryRequest &&
