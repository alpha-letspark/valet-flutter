...
class SMSBasedUpdateRequest {
  ...
  SMSBasedUpdateRequest copyWith({
    String? client_id,
    String? entry_user_id,
    String? transaction_id,
    String? vehicle_number,
  ...
  factory SMSBasedUpdateRequest.fromMap(Map<String, dynamic> map) {
    return SMSBasedUpdateRequest(
  ...
  bool operator ==(Object other) {
    ...
    return other is SMSBasedUpdateRequest &&
