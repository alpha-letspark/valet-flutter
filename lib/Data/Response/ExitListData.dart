...
class ExitListData {
  ...
  ExitListData copyWith({
    ...
    return ExitListData(
      ...
      eta_extended: eta_extended ?? this.eta_extended,
  ...
  factory ExitListData.fromMap(Map<String, dynamic> map) {
    return ExitListData(
  ...
  bool operator ==(Object other) {
    ...
    return other is ExitListData &&
        ...
        other.status == status &&
        other.eta_extended == eta_extended &&
