...
import 'package:valet_app/fragment/TodayTab/Presenter/TodayTabPresenterImpl.dart';
...
class _TodayTabState extends State<TodayTab> implements TodayTabView {
  List<HistoryData> _history = [];

  bool isOffline = false;
  bool isLoading = false;
  bool isInit = false;
  late TodayTabPresenterImpl _presenter;
  late ConnectionStatusSingleton connectionStatus;
  String searchText = '';

  _TodayTabState() {
    _presenter = TodayTabPresenterImpl();
